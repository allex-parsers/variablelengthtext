function createLib(execlib) {
  return execlib.loadDependencies('client', ['allex:base:parser'], createVariableLengthTextParser.bind(null, execlib));
}

function createVariableLengthTextParser(execlib, BaseParser) {
  'use strict';
  var lib = execlib.lib,
    q = lib.q,
